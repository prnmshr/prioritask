...
@section('content')
    ...
    <div id="quadran-cards" class="grid-quad">
        <div class="card quadran q-1 q-start" style="width: 18rem; height:auto !important;">
        ...
        <div class="card quadran q-1 q-end pb-4" style="width: 18rem; height:auto !important;">
            <table class="card-body">
                <tr>
